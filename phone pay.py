...
conn = mysql.connector.connect(user='root', password='Ajay8873@@', host='127.0.0.1', database="phonepe_pulse")
...
# DATASETS
Data_Aggregated_Transaction_df= pd.read_csv(r'C:/Users/Sushil Pande/Desktop/PhonePe-Pulse-project/data/Data_Aggregated_Transaction_Table.csv')
Data_Aggregated_User_Summary_df= pd.read_csv(r'C:/Users/Sushil Pande/Desktop/PhonePe-Pulse-project/data/Data_Aggregated_User_Summary_Table.csv')
Data_Aggregated_User_df= pd.read_csv(r'C:/Users/Sushil Pande/Desktop/PhonePe-Pulse-project/data/Data_Aggregated_User_Table.csv')
Scatter_Geo_Dataset =  pd.read_csv(r'C:/Users/Sushil Pande/Desktop/PhonePe-Pulse-project/data/Data_Map_Districts_Longitude_Latitude.csv')
Coropleth_Dataset =  pd.read_csv(r'C:/Users/Sushil Pande/Desktop/PhonePe-Pulse-project/data/Data_Map_IndiaStates_TU.csv')
Data_Map_Transaction_df = pd.read_csv(r'C:/Users/Sushil Pande/Desktop/PhonePe-Pulse-project/data/Data_Map_Transaction_Table.csv')
Data_Map_User_Table= pd.read_csv(r'C:/Users/Sushil Pande/Desktop/PhonePe-Pulse-project/data/Data_Map_User_Table.csv')
Indian_States= pd.read_csv(r'C:/Users/Sushil Pande/Desktop/PhonePe-Pulse-project/data/Longitude_Latitude_State_Table.csv')
